! function(a) {
    ...
    function(a) {
        function b(a) { return "object" == typeof a ? a : { top: a, left: a } }
        var c = a.scrollTo = function(b, c, d) { a(window).scrollTo(b, c, d) };
        c.defaults = { axis: "xy", duration: parseFloat(a.fn.jquery) >= 1.3 ? 0 : 1, limit: !0 }, c.window = function() { return a(window)._scrollable() }, a.fn._scrollable = function() {
            ...
            return "object" == typeof e && (f = e, e = 0), "function" == typeof f && (f = { onAfter: f }), "max" == d && (d = 9e9), f = a.extend({}, c.defaults, f), e = e || f.duration, f.queue = f.queue && f.axis.length > 1, f.queue && (e /= 2), f.offset = b(f.offset), f.over = b(f.over), this._scrollable().each(function() {
                function g(a) { j.animate(l, e, f.easing, a && function() { a.call(this, d, f) }) }
                if (null != d) {
                    var h, i = this,
                        j = a(i),
                        k = d,
    ...
    init: function() {
        if (this.is_pc()) {
            var a = this.$par.children().eq(0),
                ...
                h = {
                    margin_left: parseInt(a.find(".img2").css("margin-left")),
                    margin_top: parseInt(a.find(".img2").css("margin-top"))
                },
                i = {
                    margin_left: parseInt(a.find(".img0").css("margin-left")),
                    margin_top: parseInt(a.find(".img0").css("margin-top"))
                };
